...
<script>
    ...
    layui.use(['element','upload','laydate','table'], function(){
            ...
            if(selectCount >= 1){
                layer.confirm('确定删除吗？', function (index) {
                    ...
                    $.ajax({
                        ...
                        contentType: "application/json",
                        url: "${ctx}/picture",
                        data: "method=deletePictureInfo&ids=" + ids + "&status=1&code=0",
                        dataType: "json",
                        success: function (data) {
                            if (data.success) {
                                layer.msg("删除成功");
        ...
        $('#add_picture').on('click', function (){
            ...
            // 拉取图片分类数据
            window.location.href = "${ctx}/picture/task_add.jsp";
        ...
        table.on('tool(picuresList)', function(obj){
            //var data = obj.data;
            var categoryName = obj.data.category_name;
...
<script type="text/html" id="barDemo">
    <a class="layui-btn layui-btn-xs layui-btn-normal layui-btn-radius" lay-event="statusEdit">查看</a>
    <a class="layui-btn layui-btn-xs layui-btn-normal layui-btn-radius" lay-event="statusEdit1">编辑</a>
</script>
...
<div class="layui-body">
    ...
    <div class="main-top" style="padding:5px 5px 0px 5px">
        ...
        <div style="margin-top: 5px">
            ...
            <button id="add_picture" class="layui-btn layui-btn-sm" style="margin-top: 5px">添加</button>
