...
<head>
    ...
    <script>
        ...
        layui.use(['element','laydate','table'], function(){
            ...
            table.render({
                elem: '#test'
                ,url:'${pageContext.request.contextPath}/task?method=getBillList'
                //,width: 1900
                ,height: 580
                ,cols: [[
...
//                    ,{field:'id', width:100, title: 'ID',  fixed: 'left',align:'center'}
                    ...
                    ,{field:'money', width:120, title: '获奖金额(元)',align:'center' }
                    ,{field:'phone', width:120, title: '手机号',templet:'#telPhoneTpl',align:'center'}
                    ,{field:'create_date', width:150, title: '开始时间',align:'center',sort: true,templet:function (d) {
                            var index="";
                            if(d.create_date==""){
                                index="----";
                            }else {
                    ...
                    ,{field:'edit_time', width:150, title: '结束时间',align:'center',sort: true,templet:function (d) {
                            var index="";
                            if(d.edit_time==""){
                                index="----";
                            }else {
                    ...
                    ,{field:'receipts_order', width:200, title: '任务名称',align:'center' }
                    ,{field:'status', width:120, title: '完成状态', templet:'#statusTpl',align:'center'}
                    ,{field:'edit_time', width:150, title: '操作时间',align:'center',sort: true,templet:function (d) {
                            var index="";
                            if(d.edit_time==""){
                                index="----";
                            }else {
            ...
            function agree(obj) {
                ...
                $.ajax({
                    ...
                    url: "${ctx}/task?method=updateBillStatu&status=" + status +"&id="+id,//url
                    async: true,
                    data: {id: id},
