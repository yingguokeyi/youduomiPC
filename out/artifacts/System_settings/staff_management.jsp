                        ...
                        if (deptId && (deptSourceMap.size() > 0)) {
                            ...
                            if (roleId && (roleSourceMap.size() > 0)) {
                                ...
                                roleSourceMap.each(function (value, key) {
                                    console.log(" key " + key + " value  " + value);
                                    if (value == roleId) {
                                        $("#u_role").append("<option value='" + key + "' selected> " +" "+ key + "</option>");
                                    } else {
                                        $("#u_role").append("<option value='" + key + "'> "+" " + key + "</option>");
                                    }
                                });
                            }
            ...
            <div style="display: none;">
                ...
                <form class="layui-form">
                    ...
                    <div class="layui-form-item">
                        <label class="layui-form-label"><label style="color: red">*</label>账号</label>
                        <div class="layui-input-block" style="width: 400px;">
                            <input type="text" id="i_login_name" name="i_login_name" placeholder="账号"
                                   autocomplete="off" class="layui-input">
                        </div>
                    </div>
                    ...
                    <div class="layui-form-item">
                        <label class="layui-form-label"><label style="color: red">*</label>手机号</label>
                        <div class="layui-input-inline" style="width: 400px;">
                            <input type="text" id="i_phone" name="u_phone"
                                   placeholder="请输入手机号"
                                   autocomplete="off" class="layui-input">
                        </div>
                    </div>
